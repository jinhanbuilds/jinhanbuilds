...
Coding 已经积累了越来越多公开、可复用的 Agent 工作方式；而在那些模糊、上下文密集、依赖判断与组织协作的复杂工作中，许多有效实践仍散落在个人经验里。我正在把其中经得住真实使用的部分整理并公开，让更多人可以把它们带回自己的工作，用 Agent 来思考、创造与协作，并从实际使用中发展出新的做法。

这套视角来自八年战略咨询。作为合伙人，我也推动公司里不同职能的同事把 AI 用进日常工作，并持续分享、交流各自的真实用法。如今，我在自己经营的公司里，从产品和业务到团队日常继续探索，让这些实践随着 Agent 能力的变化和新的现实问题持续迭代。

## 从这里开始

以下五个 Agent Skill 是目前已经公开、可以直接使用的入口：

- **[Hoist the Elephant](https://github.com/jinhanbuilds/hoist-the-elephant)**：一个只在用户明确调用时使用的 Agent Skill；当长对话被一轮轮局部修正带偏，先把惯性停下来，再恢复真正应该支配后续工作的主线。
- **[不是而是](https://github.com/jinhanbuilds/bushiershi)**：一个对抗模型输出不良表达习惯的 Agent Skill，只处理读者实际看到的最终成稿，不以改得更顺为代价改变事实、程度、归因或不确定性。
- **[Better Decisions](https://github.com/jinhanbuilds/better-decisions)**：把战略咨询顾问形成建议之前的工作变成 Agent 必须遵守的决策纪律；面对非简单决定，先建立这项决定所需的最小充分决策基础。
- **[Brief Me](https://github.com/jinhanbuilds/brief-me)**：把 AI 的一墙分析变成一份真正能看懂、能操作、能据此拍板的顾问式视觉汇报。
- **[Wish Pool](https://github.com/jinhanbuilds/wish-pool)**：一个本地优先的 Agent Skill 与可视化看板，把散落在不同 Agent Session 里的灵感变成以后看得懂、找得到、接得回来的同一张卡。

## 这件事早于创业

### AI 先改变了我的工作

从 2023 年开始，我持续把 ChatGPT 深入用进真实工作。

Research / synthesis / hypothesis / decision support / writing / communication / management…

从快速进入陌生行业、消化分散材料与模糊信息，到提出和反驳假设、形成判断，再到客户表达、团队沟通与日常管理，AI 逐渐进入了复杂工作中从理解问题到推动结果的不同阶段。

对我而言，模型升级也不再只是一条产品新闻，而是工作边界在现实中移动。2023、2024、2025，每一年，都有一部分原来由我或团队完成的工作开始可以交给 AI：有的工作真的少掉一块，有的环节开始可以由更少的人推进。

### 接着，它进入了一个组织

作为一家战略咨询公司的合伙人，我推动公司为不同职能的同事配上 AI 账号——从咨询顾问到品牌、行政、HR 和财务——也让“今天用 AI 实现了什么”成为组织里持续交流的话题。

我自己会持续分享使用中的 aha moment，也鼓励团队把各自真实的使用片段拿出来——因为方法可以借鉴，但能不能真正帮到另一个人，往往取决于彼此面对的工作场景是否足够相似。这种围绕实际使用的跨职能交流持续了三年多。

这段经历也把问题推深了一层：一个组织真正会用 AI，并不等于其中每个人都有一个 AI 账号。更难的是，怎样让分散在个人身上的实践被看见、被接住，并逐渐成为团队能够持续复用的能力。

### 现在，我在经营一家 AI-native startup

2026 年，我选择成为 Founder，想把两条线放进一家真实运行的公司。

一条，是把过去在咨询中反复做的苦活——理解陌生问题、处理复杂信息、形成判断并推动结果——重新做成由 Agent、工作流和产品承载的能力；另一条，是从头探索 AI-native work 与组织协作会长成什么样。

成为 Founder 后，产品、业务、团队和组织本身，都成了需要从头回答的问题：

一家 AI-native company 里，什么会变快，什么反而会变慢？当每个人都有自己的 Agent，也都有难以交接的长上下文，团队该怎样继续协作？

这些不是我站在公司外面研究的题目，而是在产品、业务和团队的日常运行中，必须持续作答的问题。

GitHub 是这条分享路径向外延伸的一部分。我开始把真实实践中反复出现、逐渐成形的做法整理出来，让更多人可以使用、改造，并在自己的工作中继续发展。

## 我所说的 AI-native work beyond coding

我所说的 **AI-native work beyond coding**，是探索 Agent 如何进入 coding 之外更广泛的真实工作。当它从完成一个局部任务，逐渐参与一件事怎样被想清楚、做出来并继续推进，工作如何开始、怎样形成判断、如何交接与协作，也会随之变化。

Thinking、Creating、Collaborating 是目前反复出现在这些实践里的三条主线：

- **Thinking / 思考**：让 Agent 参与研究、梳理和质疑，帮助人看清问题，形成更有依据的判断。
- **Creating / 创造**：让人与 Agent 一起把尚未成形的想法，逐渐变成可以使用、修改和继续发展的成果。
- **Collaborating / 协作**：让目标、上下文和进展能够跨时间、Session、Agent 与人延续，使一项工作更容易被接住和共同推进。

在这样的协作中，Agent 可以承担更多查找、整理、推演和推进工作；人继续定义目标、作出取舍、修正方向并对结果负责。我关心的是，这种分工能否在真实工作和组织中持续运转，让人始终能够理解、质疑和改变 Agent 的工作。

## 我正在公开构建什么

我会把真实工作中反复出现的问题，以及围绕它们逐渐形成的可用做法，整理并公开在这里。处在相似工作场景中的人，可以把这些做法带回自己的工作中使用、修改，并从新的实践中继续迭代。目前，我先从一组 Agent Skills 开始。

它们来自我每天正在推进的工作。以 [可见信号](https://vis-signal.com/) 为例，我们需要选择和维护值得持续跟踪的信息源，为不同类型的信息设计 Agent 处理链路，把行业理解和人的判断融入筛选、解释与输出，再根据团队实际处理的内容和产品反馈继续调整。

我会优先整理那些已经在工作中用过、开始显出复用价值的做法。公开出来的版本也会随着新的业务问题、Agent 能力和使用反馈继续迭代。
...
These Agent Skills are the current public entry points into this work:

- **[Hoist the Elephant](https://github.com/jinhanbuilds/hoist-the-elephant)** — An explicit-only Agent Skill for re-anchoring a long conversation that has drifted through repeated local corrections.
- **[不是而是](https://github.com/jinhanbuilds/bushiershi)** — An explicit-only Agent Skill for correcting recurring problems in model-written Chinese. It controls only the final text the reader sees and does not trade faithfulness for smoother prose.
- **[Better Decisions](https://github.com/jinhanbuilds/better-decisions)** — Turns the pre-recommendation work of strategy consulting into a decision discipline the Agent must follow, first building the minimum-sufficient decision basis for a nontrivial decision.
- **[Brief Me](https://github.com/jinhanbuilds/brief-me)** — Turns AI’s wall of analysis into a consultant-style visual briefing you can explore, respond to, and decide from.
- **[Wish Pool](https://github.com/jinhanbuilds/wish-pool)** — A local-first Agent Skill and visual board that turns ideas scattered across Agent sessions into durable cards you can find, update, hand off, and continue later.

### This started before the startup

#### AI changed my work first
...
#### Then it entered an organization
...
#### Now I’m running an AI-native startup
...
### What I mean by AI-native work beyond coding
